...
public:
    ...
    virtual Zcad::ErrorStatus setChaelFlags(ZcGiMaterialTraits::ChannelFlags value);
    ...
    ZcGiMaterialTraits2::LuminanceMode luminanceMode () const;
    Zcad::ErrorStatus   setLuminanceMode        (ZcGiMaterialTraits2::LuminanceMode value);
    ...
    Zcad::ErrorStatus   normalMap               (ZcGiMaterialMap & map,
                                                 ZcGiMaterialTraits2::NormalMapMethod & method,
    ...
    ZcGiMaterialTraits2::GlobalIlluminationMode globalIllumination() const;
    void                setGlobalIllumination   (ZcGiMaterialTraits2::GlobalIlluminationMode mode);

    ZcGiMaterialTraits2::FinalGatherMode        finalGather() const;
    void                setFinalGather          (ZcGiMaterialTraits2::FinalGatherMode mode);
};
