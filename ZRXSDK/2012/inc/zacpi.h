...
typedef   DECLSPEC_UUID("E969120C-E81A-47F9-9131-5CB9CBEDC21B")
enum ZcPiColorIndex
    {	ZCPI_COLOR_TOP	= 0,
...
EXTERN_C const IID IID_IZcPiPropertyInspector;
    ...
    MIDL_INTERFACE("BEF8D63E-E73E-444F-8672-B88E0AACEFC4")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_Reset_Proxy(
    IZcPiPropertyInspector * This,
     VARIANT *pObjUnkArray,
     VARIANT *pDynUnkArray,
     DWORD dwFlags);
void __RPC_STUB IZcPiPropertyInspector_Reset_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChaelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_get_Style_Proxy(
    IZcPiPropertyInspector * This,
     DWORD *pVal);
void __RPC_STUB IZcPiPropertyInspector_get_Style_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_put_Style_Proxy(
    IZcPiPropertyInspector * This,
     DWORD newVal);
void __RPC_STUB IZcPiPropertyInspector_put_Style_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_get_KeepFocus_Proxy(
    IZcPiPropertyInspector * This,
     VARIANT_BOOL *pVal);
void __RPC_STUB IZcPiPropertyInspector_get_KeepFocus_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_SetColor_Proxy(
    IZcPiPropertyInspector * This,
     ZcPiColorIndex index,
     OLE_COLOR color);
void __RPC_STUB IZcPiPropertyInspector_SetColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_GetColor_Proxy(
    IZcPiPropertyInspector * This,
     ZcPiColorIndex __MIDL_0011,
     OLE_COLOR *pColor);
void __RPC_STUB IZcPiPropertyInspector_GetColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_get_Font_Proxy(
    IZcPiPropertyInspector * This,
     IUnknown **pIFont);
void __RPC_STUB IZcPiPropertyInspector_get_Font_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_put_Font_Proxy(
    IZcPiPropertyInspector * This,
     IUnknown *pIFont);
void __RPC_STUB IZcPiPropertyInspector_put_Font_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_get_BoldFont_Proxy(
    IZcPiPropertyInspector * This,
     IUnknown **pIFont);
void __RPC_STUB IZcPiPropertyInspector_get_BoldFont_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_put_BoldFont_Proxy(
    IZcPiPropertyInspector * This,
     IUnknown *pIFont);
void __RPC_STUB IZcPiPropertyInspector_put_BoldFont_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_SetPersistence_Proxy(
    IZcPiPropertyInspector * This,
     IUnknown *pINode);
void __RPC_STUB IZcPiPropertyInspector_SetPersistence_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_GetPersistence_Proxy(
    IZcPiPropertyInspector * This,
     IUnknown *pINode);
void __RPC_STUB IZcPiPropertyInspector_GetPersistence_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_get_DelayRefresh_Proxy(
    IZcPiPropertyInspector * This,
     VARIANT_BOOL *pbDelayRefresh);
void __RPC_STUB IZcPiPropertyInspector_get_DelayRefresh_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspector_put_DelayRefresh_Proxy(
    IZcPiPropertyInspector * This,
     VARIANT_BOOL bDelayRefresh);
...
EXTERN_C const IID IID_IZcPiPropertyEditControl;
    ...
    MIDL_INTERFACE("D8CD2EE7-4411-41FE-BF2F-3B9306D55FD1")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_InitEditControl_Proxy(
    IZcPiPropertyEditControl * This,
     LPVARIANT pVarObjDispArray,
     LPVARIANT pVarDynPropArray,
     LPVARIANT pDispidArray,
...
void __RPC_STUB IZcPiPropertyEditControl_InitEditControl_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_Refresh_Proxy(
    IZcPiPropertyEditControl * This,
     DWORD dwFlags);
void __RPC_STUB IZcPiPropertyEditControl_Refresh_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_get_KeepFocus_Proxy(
    IZcPiPropertyEditControl * This,
     VARIANT_BOOL *pVal);
void __RPC_STUB IZcPiPropertyEditControl_get_KeepFocus_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_put_BackColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR clr);
void __RPC_STUB IZcPiPropertyEditControl_put_BackColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_get_BackColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR *pclr);
void __RPC_STUB IZcPiPropertyEditControl_get_BackColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_put_ForeColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR clr);
void __RPC_STUB IZcPiPropertyEditControl_put_ForeColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_get_ForeColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR *pclr);
void __RPC_STUB IZcPiPropertyEditControl_get_ForeColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_put_ReadOnlyBackColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR clr);
void __RPC_STUB IZcPiPropertyEditControl_put_ReadOnlyBackColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_get_ReadOnlyBackColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR *pclr);
void __RPC_STUB IZcPiPropertyEditControl_get_ReadOnlyBackColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_put_ReadOnlyForeColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR clr);
void __RPC_STUB IZcPiPropertyEditControl_put_ReadOnlyForeColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_get_ReadOnlyForeColor_Proxy(
    IZcPiPropertyEditControl * This,
     OLE_COLOR *pclr);
void __RPC_STUB IZcPiPropertyEditControl_get_ReadOnlyForeColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_put_Font_Proxy(
    IZcPiPropertyEditControl * This,
     IUnknown *pIFont);
void __RPC_STUB IZcPiPropertyEditControl_put_Font_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditControl_get_Font_Proxy(
    IZcPiPropertyEditControl * This,
     IUnknown **pIFont);
...
EXTERN_C const IID IID_IZcPiPropertyEditEventsSink;
    ...
    MIDL_INTERFACE("E765A043-C70D-4F1B-83AD-622F5ABB5BA3")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnClick_Proxy(
    IZcPiPropertyEditEventsSink * This);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnClick_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnDblClick_Proxy(
    IZcPiPropertyEditEventsSink * This);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnDblClick_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnKeyDown_Proxy(
    IZcPiPropertyEditEventsSink * This,
     LONG_PTR pnChar,
     LONG_PTR keyData);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnKeyDown_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnKeyUp_Proxy(
    IZcPiPropertyEditEventsSink * This,
     LONG_PTR pnChar,
     LONG_PTR keyData);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnKeyUp_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnRButtonDown_Proxy(
    IZcPiPropertyEditEventsSink * This,
     WPARAM wParam,
     LPARAM lParam);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnRButtonDown_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnMButtonDown_Proxy(
    IZcPiPropertyEditEventsSink * This,
     WPARAM wParam,
     LPARAM lParam);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnMButtonDown_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnBeginPropertyUpdate_Proxy(
    IZcPiPropertyEditEventsSink * This);
void __RPC_STUB IZcPiPropertyEditEventsSink_OnBeginPropertyUpdate_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyEditEventsSink_OnEndPropertyUpdate_Proxy(
    IZcPiPropertyEditEventsSink * This);
...
EXTERN_C const IID IID_IZcPiPropertyUnspecified;
    ...
    MIDL_INTERFACE("43806682-BA4A-4605-A88D-77E9538336FA")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyUnspecified_IsValueUnspecified_Proxy(
    IZcPiPropertyUnspecified * This,
     VARIANT varId,
     VARIANT_BOOL *pVal);
void __RPC_STUB IZcPiPropertyUnspecified_IsValueUnspecified_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyUnspecified_SetUnspecified_Proxy(
    IZcPiPropertyUnspecified * This,
     VARIANT varId,
     VARIANT_BOOL bIsUnspecified);
void __RPC_STUB IZcPiPropertyUnspecified_SetUnspecified_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyUnspecified_IsUnspecifiedAllowed_Proxy(
    IZcPiPropertyUnspecified * This,
     VARIANT varId,
     VARIANT_BOOL *pVal);
void __RPC_STUB IZcPiPropertyUnspecified_IsUnspecifiedAllowed_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyUnspecified_GetUnspecifiedString_Proxy(
    IZcPiPropertyUnspecified * This,
     VARIANT varId,
     BSTR *pVal);
...
EXTERN_C const IID IID_IZcPiPropertyDisplay;
    ...
    MIDL_INTERFACE("2617FBDB-8353-48D8-9F52-30518E618D07")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyDisplay_GetCustomPropertyCtrl_Proxy(
    IZcPiPropertyDisplay * This,
     VARIANT Id,
     LCID lcid,
     BSTR *pProgId);
void __RPC_STUB IZcPiPropertyDisplay_GetCustomPropertyCtrl_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyDisplay_GetPropertyIcon_Proxy(
    IZcPiPropertyDisplay * This,
     VARIANT Id,
     IUnknown **pIcon);
void __RPC_STUB IZcPiPropertyDisplay_GetPropertyIcon_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyDisplay_GetPropTextColor_Proxy(
    IZcPiPropertyDisplay * This,
     VARIANT Id,
     OLE_COLOR *pTextColor);
void __RPC_STUB IZcPiPropertyDisplay_GetPropTextColor_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyDisplay_IsFullView_Proxy(
    IZcPiPropertyDisplay * This,
     VARIANT Id,
     VARIANT_BOOL *pbVisible,
     DWORD *pIntegralHeight);
void __RPC_STUB IZcPiPropertyDisplay_IsFullView_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyDisplay_GetPropertyWeight_Proxy(
    IZcPiPropertyDisplay * This,
     VARIANT Id,
     long *pPropertyWeight);
...
EXTERN_C const IID IID_IZcPiCategorizeProperties;
    ...
    MIDL_INTERFACE("6CB44A48-5129-46DF-88D0-8E3424A55A56")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_MapPropertyToCategory_Proxy(
    IZcPiCategorizeProperties * This,
     DISPID dispID,
     int *pCatID);
void __RPC_STUB IZcPiCategorizeProperties_MapPropertyToCategory_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_GetCategoryName_Proxy(
    IZcPiCategorizeProperties * This,
     int CatID,
     LCID lCid,
     BSTR *pCategoryName);
void __RPC_STUB IZcPiCategorizeProperties_GetCategoryName_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_GetCategoryDescription_Proxy(
    IZcPiCategorizeProperties * This,
     int CatID,
     LCID lCid,
     BSTR *pCategoryDescription);
void __RPC_STUB IZcPiCategorizeProperties_GetCategoryDescription_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_GetCategoryWeight_Proxy(
    IZcPiCategorizeProperties * This,
     int CatID,
     long *pCategoryWeight);
void __RPC_STUB IZcPiCategorizeProperties_GetCategoryWeight_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_GetParentCategory_Proxy(
    IZcPiCategorizeProperties * This,
     int CatID,
     int *pParentCatID);
void __RPC_STUB IZcPiCategorizeProperties_GetParentCategory_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_GetUniqueID_Proxy(
    IZcPiCategorizeProperties * This,
     BSTR *pVal);
void __RPC_STUB IZcPiCategorizeProperties_GetUniqueID_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCategorizeProperties_GetCommandButtons_Proxy(
    IZcPiCategorizeProperties * This,
     int CatID,
     VARIANT *pCatCmdBtns);
...
EXTERN_C const IID IID_IZcPiPropCommandButtons;
    ...
    MIDL_INTERFACE("EA1682CB-53E2-4AF0-91C4-432DA462A737")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropCommandButtons_GetButtons_Proxy(
    IZcPiPropCommandButtons * This,
     VARIANT *pButtons);
...
EXTERN_C const IID IID_IZcPiCommandButton;
    ...
    MIDL_INTERFACE("FB2C0DD6-DBD6-4A15-B497-34A18058B8AB")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_GetName_Proxy(
    IZcPiCommandButton * This,
     LCID lcid,
     BSTR *name);
void __RPC_STUB IZcPiCommandButton_GetName_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_get_EnabledPicture_Proxy(
    IZcPiCommandButton * This,
     IUnknown **pPicture);
void __RPC_STUB IZcPiCommandButton_get_EnabledPicture_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_get_DisabledPicture_Proxy(
    IZcPiCommandButton * This,
     IUnknown **pPicture);
void __RPC_STUB IZcPiCommandButton_get_DisabledPicture_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_get_Enabled_Proxy(
    IZcPiCommandButton * This,
     VARIANT_BOOL *bEnabled);
void __RPC_STUB IZcPiCommandButton_get_Enabled_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_put_Enabled_Proxy(
    IZcPiCommandButton * This,
     VARIANT_BOOL bEnabled);
void __RPC_STUB IZcPiCommandButton_put_Enabled_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_get_Checked_Proxy(
    IZcPiCommandButton * This,
     VARIANT_BOOL *bChecked);
void __RPC_STUB IZcPiCommandButton_get_Checked_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_put_Checked_Proxy(
    IZcPiCommandButton * This,
     VARIANT_BOOL bChecked);
void __RPC_STUB IZcPiCommandButton_put_Checked_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_get_ButtonStyle_Proxy(
    IZcPiCommandButton * This,
     long *style);
void __RPC_STUB IZcPiCommandButton_get_ButtonStyle_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton_Execute_Proxy(
    IZcPiCommandButton * This,
     VARIANT Objects);
...
EXTERN_C const IID IID_IZcPiCommandButton2;
    ...
    MIDL_INTERFACE("192BFC32-8DD2-4DA7-8A3F-8C7CF935EFAA")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton2_get_CheckedPicture_Proxy(
    IZcPiCommandButton2 * This,
     IUnknown **pPicture);
void __RPC_STUB IZcPiCommandButton2_get_CheckedPicture_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiCommandButton2_get_UncheckedPicture_Proxy(
    IZcPiCommandButton2 * This,
     IUnknown **pPicture);
...
EXTERN_C const IID IID_IZcPiPropertyInspectorEventsSink;
    ...
    MIDL_INTERFACE("521A516F-D016-48EE-A95E-D99E89DFA5BD")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspectorEventsSink_Rebuild_Proxy(
    IZcPiPropertyInspectorEventsSink * This,
     DWORD dwFlags);
void __RPC_STUB IZcPiPropertyInspectorEventsSink_Rebuild_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspectorEventsSink_RefreshControl_Proxy(
    IZcPiPropertyInspectorEventsSink * This,
     VARIANT var,
     DWORD dwFlags);
void __RPC_STUB IZcPiPropertyInspectorEventsSink_RefreshControl_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspectorEventsSink_GetPropertyControl_Proxy(
    IZcPiPropertyInspectorEventsSink * This,
     VARIANT var,
     IUnknown **ppUnk);
...
EXTERN_C const IID IID_IZcPiPropertyInspectorInputEventSink;
    ...
    MIDL_INTERFACE("8EF61F10-131E-4590-9F20-D339BDA84819")
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspectorInputEventSink_OnKeyDown_Proxy(
    IZcPiPropertyInspectorInputEventSink * This,
     long pnChar,
     long keyData);
void __RPC_STUB IZcPiPropertyInspectorInputEventSink_OnKeyDown_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspectorInputEventSink_OnPopulateContextMenu_Proxy(
    IZcPiPropertyInspectorInputEventSink * This,
     VARIANT *flagArray,
     VARIANT *idArray,
     VARIANT *szItemArray);
void __RPC_STUB IZcPiPropertyInspectorInputEventSink_OnPopulateContextMenu_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPiPropertyInspectorInputEventSink_OnContextMenuCommand_Proxy(
    IZcPiPropertyInspectorInputEventSink * This,
     int cmdId);
...
class DECLSPEC_UUID("E15C2119-5054-4DB8-9F3D-CF1B13710845")
