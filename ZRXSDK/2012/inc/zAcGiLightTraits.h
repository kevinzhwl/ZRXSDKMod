...
class ZcGiShadowParameters2 : public ZcGiShadowParameters
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiShadowParameters2);

              ZcGiShadowParameters2 (void);
    explicit  ZcGiShadowParameters2 (const ZcGiShadowParameters& params);
    virtual  ~ZcGiShadowParameters2 (void);

    bool operator==(const ZcGiShadowParameters2& params) const;
...
class ZcGiPointLightTraits2 : public ZcGiPointLightTraits
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiPointLightTraits2);
    ...
    virtual void setShadowParameters(const ZcGiShadowParameters2& params) = 0;
    virtual void shadowParameters(ZcGiShadowParameters2& params) const = 0;
...
class ZcGiDistantLightTraits2 : public ZcGiDistantLightTraits
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiDistantLightTraits2);
    virtual void setPhysicalIntensity(double physicalIntensity) = 0;
    virtual double physicalIntensity() const = 0;
    virtual void setLampColor (const ZcGiColorRGB& rgbColor) = 0;
    virtual void lampColor (ZcGiColorRGB& rgbColor) const = 0;
...
class ZcGiWebLightTraits : public ZcGiPointLightTraits2
{
public:
