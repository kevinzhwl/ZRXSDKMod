...
bool   zcdbDisplayPreviewFromDwg(const ZTCHAR *pszDwgfilename,
                                 void* pPreviewWnd,
                                 const ZSoft::UInt32* pBgColor = NULL);
...
{
    return ::zcdbOpenZcDbObject((ZcDbObject * &)pObj, id, mode,
                                T_OBJECT::desc(), openErased);
}

inline Zcad::ErrorStatus zcdbOpenObject(
    ZcDbObject *& pObj, ZcDbObjectId id, ZcDb::OpenMode mode)
{
    return ::zcdbOpenZcDbObject(pObj, id, mode, false);
}

inline Zcad::ErrorStatus zcdbOpenObject(
    ZcDbEntity *& pEnt, ZcDbObjectId id, ZcDb::OpenMode mode)
{
    return ::zcdbOpenZcDbEntity(pEnt, id, mode, false);
}
...
inline Zcad::ErrorStatus zcdbOpenObject(
    ...
    bool openErased)
{
    return ::zcdbOpenZcDbObject(pObj, id, mode, openErased);
}
...
inline Zcad::ErrorStatus zcdbOpenObject(
    ...
    bool openErased)
{
    return ::zcdbOpenZcDbEntity(pEnt, id, mode, openErased);
}
...
#ifdef MEM_DEBUG
void*             zcdbAlloc_dbg(size_t ZCDBG_FORMAL);
void*             zcdbRealloc_dbg(void *, size_t ZCDBG_FORMAL);
#define zcdbAlloc(a) zcdbAlloc_dbg(a, /*__FILE__*/"", /*__LINE__*/1)
#define zcdbRealloc(a, b) zcdbRealloc_dbg(a, b, /*__FILE__*/"", /*__LINE__*/1)
#endif
void  zcdbFree(void*);

Zcad::ErrorStatus zcdbValidateSetup(long lcid);
...
Zcad::ErrorStatus zcdbDxfOutAsR14(ZcDbDatabase* pDb,
...
public:
    ...
    ZcDbObjectId  blockTableId();
    ZcDbObjectId  layerTableId();
    ZcDbObjectId  textStyleTableId();
    ZcDbObjectId  linetypeTableId();
    ZcDbObjectId  viewTableId();
    ZcDbObjectId  UCSTableId();
    ZcDbObjectId  viewportTableId();
    ZcDbObjectId  regAppTableId();
    ZcDbObjectId  dimStyleTableId();
    ZcDbObjectId  mLStyleDictionaryId();
    ZcDbObjectId  groupDictionaryId();
    ZcDbObjectId  layoutDictionaryId();
    ZcDbObjectId  plotStyleNameDictionaryId();
    ZcDbObjectId  materialDictionaryId();
    ZcDbObjectId  visualStyleDictionaryId();
    ZcDbObjectId  colorDictionaryId();
    ZcDbObjectId  scaleListDictionaryId();
    ZcDbObjectId  namedObjectsDictionaryId();
    ZcDbObjectId  plotSettingsDictionaryId();
    ...
    Zcad::ErrorStatus setXclipFrame(bool disp);
...
public:
    ...
    virtual resbuf*           xData   (const ZTCHAR* regappName = NULL) const;
...
public:
    ...
    void                      getDictionaryKey(ZTCHAR *) const;
...
bool zcdbTextFind(ZcDbDatabase* pDatabase,
                  ...
                  const ZTCHAR* replaceString = NULL,
