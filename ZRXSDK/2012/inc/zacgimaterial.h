...
class ZcGiMaterialTraits2 : public ZcGiMaterialTraits
{
public:
    ZCRX_DECLARE_MEMBERS(ZcGiMaterialTraits2);
...
public:
    ...
    ZSOFT_DEPRECATED virtual void setTiling         (Tiling tiling);
    ...
    ZSOFT_DEPRECATED virtual    Tiling                 tiling        (void) const;
