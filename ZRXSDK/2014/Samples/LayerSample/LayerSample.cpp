...
void initApp()
{
	acedRegCmds->addCommand("LAYERSAMPLE", "CreateLayer", "CreateLayer", ACRX_CMD_TRANSPARENT, CreateLayer);
	acedRegCmds->addCommand("LAYERSAMPLE", "ModifyLayerProp", "ModifyLayerProp", ACRX_CMD_TRANSPARENT, ModifyLayerProp);
	acedRegCmds->addCommand("LAYERSAMPLE", "ModifyEntityLayer", "ModifyEntityLayer", ACRX_CMD_TRANSPARENT, ModifyEntityLayer);
	acedRegCmds->addCommand("LAYERSAMPLE", "DelLayer", "DelLayer", ACRX_CMD_TRANSPARENT, DelLayer);
}

void unloadApp()
{
	acedRegCmds->removeGroup("LAYERSAMPLE");
}
