...
class ZSOFT_NO_VTABLE ZcDbDwgFiler: public ZcRxObject
{
  public:
    ...
    virtual Zcad::ErrorStatus   readBytes(void *, ZSoft::UInt32) = 0;
    virtual Zcad::ErrorStatus   writeBytes(const void *, ZSoft::UInt32) = 0;
    ...
    virtual Zcad::ErrorStatus   writeAddress(const void *);
            ...
            Zcad::ErrorStatus   readItem(void *, ZSoft::UInt32);
            Zcad::ErrorStatus   writeItem(const void *, ZSoft::UInt32);
...
public:
	...
	Zcad::ErrorStatus writeItem (ZcDb::DxfCode, ZSoft::Int64);
	...
	Zcad::ErrorStatus writeItem (ZcDb::DxfCode, ZSoft::UInt64);
...
#ifdef ZSoft_Boolean_is_bool
inline Zcad::ErrorStatus ZcDbDwgFiler::readItem(int* pVal)
{   return readInt(pVal);            }

inline Zcad::ErrorStatus ZcDbDwgFiler::writeItem(int val)
{   return writeInt(val);            }
#else
...
inline Zcad::ErrorStatus ZcDbDwgFiler::readItem(void *buf, ZSoft::UInt32 cnt)
{   return readBytes(buf, cnt);     }

inline Zcad::ErrorStatus 
ZcDbDwgFiler::writeItem(const void *buf, ZSoft::UInt32 cnt)
...
inline Zcad::ErrorStatus
ZcDbDxfFiler::writeItem(ZcDb::DxfCode dc, ZSoft::Int64 val)
{   return writeInt64(dc, val);        }
...
inline Zcad::ErrorStatus
ZcDbDxfFiler::writeItem(ZcDb::DxfCode dc, ZSoft::UInt64 val)
{   return writeUInt64(dc, val);        }
...
#ifdef ZSoft_Boolean_is_bool
inline Zcad::ErrorStatus
ZcDbDxfFiler::writeItem(ZcDb::DxfCode dc, int val)
