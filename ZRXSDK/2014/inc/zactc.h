...
public:
    ...
    BOOL                GetImageInfo        (INT_PTR iIndex,
                                             ZCTC_IMAGE_INFO* pImageInfo) const;
    BOOL                SetImageInfo        (INT_PTR iIndex,
                                             const ZCTC_IMAGE_INFO* pImageInfo);
    ZcTcImage*          GetImage            (INT_PTR iIndex);
    INT_PTR             SetImage            (INT_PTR iIndex,
                                             const ZcTcImage* pImage);
    INT_PTR             Add                 (const ZcTcImage* pImage);
    INT_PTR             Add                 (const ZCTC_IMAGE_INFO* pImageInfo);
    INT_PTR             UpdateImage         (const ZcTcImage* pImage);
...
public:
    ...
    ZcTcImage       *   GetImage            (const SIZE* pSize);
    ...
    ZcTcImage       *   GetOverlayImage     (void) const;
    BOOL                SetOverlayImage     (const ZcTcImage* pImage);
    BOOL                GetOverlayImageInfo (ZCTC_IMAGE_INFO* pImageInfo) const;
