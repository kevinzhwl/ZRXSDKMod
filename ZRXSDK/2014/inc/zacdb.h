...
#define ZCDB_SERVICES                  ZCRX_T("ZcDbServices")
...
#define ZCDB_BROKEN_HANDLE             ZCRX_T("FFFFFFFF")
...
#define ZCDB_ANNOTATIONSCALES_COLLECTION ZCRX_T("ACDB_ANNOTATIONSCALES")
...
struct ZcDb
{
    ...
    enum MaintenanceReleaseVersion
                           { kMRelease0         = 0,
                             ...
                             kMRelease113       = 113,
                             kMRelease114       = 114,
                             kMReleaseNewest    = kMRelease8,
                             kMRelease2010Newest = kMRelease109,
