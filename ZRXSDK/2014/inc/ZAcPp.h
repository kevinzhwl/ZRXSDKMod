...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_Value_Proxy(
    IZcPpZcadInput * This,
     VARIANT *pVal);
void __RPC_STUB IZcPpZcadInput_get_Value_Stub(
    ...
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_Value_Proxy(
    IZcPpZcadInput * This,
     VARIANT newVal);
void __RPC_STUB IZcPpZcadInput_put_Value_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_Status_Proxy(
    IZcPpZcadInput * This,
     long *pVal);
void __RPC_STUB IZcPpZcadInput_get_Status_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_Status_Proxy(
    IZcPpZcadInput * This,
     long newVal);
void __RPC_STUB IZcPpZcadInput_put_Status_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_Document_Proxy(
    IZcPpZcadInput * This,
     IUnknown **pVal);
void __RPC_STUB IZcPpZcadInput_get_Document_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_Document_Proxy(
    IZcPpZcadInput * This,
     IUnknown *newVal);
void __RPC_STUB IZcPpZcadInput_put_Document_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_CrOnly_Proxy(
    IZcPpZcadInput * This,
     VARIANT_BOOL *pVal);
void __RPC_STUB IZcPpZcadInput_get_CrOnly_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_CrOnly_Proxy(
    IZcPpZcadInput * This,
     VARIANT_BOOL newVal);
void __RPC_STUB IZcPpZcadInput_put_CrOnly_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_Prompt_Proxy(
    IZcPpZcadInput * This,
     BSTR *pVal);
void __RPC_STUB IZcPpZcadInput_get_Prompt_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_Prompt_Proxy(
    IZcPpZcadInput * This,
     BSTR newVal);
void __RPC_STUB IZcPpZcadInput_put_Prompt_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_Prompt2_Proxy(
    IZcPpZcadInput * This,
     BSTR *pVal);
void __RPC_STUB IZcPpZcadInput_get_Prompt2_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_Prompt2_Proxy(
    IZcPpZcadInput * This,
     BSTR newVal);
void __RPC_STUB IZcPpZcadInput_put_Prompt2_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_InitGetBit_Proxy(
    IZcPpZcadInput * This,
     long *pVal);
void __RPC_STUB IZcPpZcadInput_get_InitGetBit_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_InitGetBit_Proxy(
    IZcPpZcadInput * This,
     long newVal);
void __RPC_STUB IZcPpZcadInput_put_InitGetBit_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_InitGetKword_Proxy(
    IZcPpZcadInput * This,
     BSTR *pVal);
void __RPC_STUB IZcPpZcadInput_get_InitGetKword_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_InitGetKword_Proxy(
    IZcPpZcadInput * This,
     BSTR newVal);
void __RPC_STUB IZcPpZcadInput_put_InitGetKword_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_BasePoint_Proxy(
    IZcPpZcadInput * This,
     VARIANT *pVal);
void __RPC_STUB IZcPpZcadInput_get_BasePoint_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_BasePoint_Proxy(
    IZcPpZcadInput * This,
     VARIANT newVal);
void __RPC_STUB IZcPpZcadInput_put_BasePoint_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_PromptType_Proxy(
    IZcPpZcadInput * This,
     short *pVal);
void __RPC_STUB IZcPpZcadInput_get_PromptType_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_PromptType_Proxy(
    IZcPpZcadInput * This,
     short newVal);
void __RPC_STUB IZcPpZcadInput_put_PromptType_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_get_EnableNotification_Proxy(
    IZcPpZcadInput * This,
     VARIANT_BOOL *pVal);
void __RPC_STUB IZcPpZcadInput_get_EnableNotification_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_put_EnableNotification_Proxy(
    IZcPpZcadInput * This,
     VARIANT_BOOL newVal);
void __RPC_STUB IZcPpZcadInput_put_EnableNotification_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_DoPrompt_Proxy(
    IZcPpZcadInput * This);
void __RPC_STUB IZcPpZcadInput_DoPrompt_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpZcadInput_CancelPrompt_Proxy(
    IZcPpZcadInput * This);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpPalette_get_Name_Proxy(
    IZcPpPalette * This,
     BSTR *name);
void __RPC_STUB IZcPpPalette_get_Name_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPalette_put_Name_Proxy(
    IZcPpPalette * This,
     BSTR name);
void __RPC_STUB IZcPpPalette_put_Name_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPalette_get_InspectorControl_Proxy(
    IZcPpPalette * This,
     IZcPiPropertyInspector **pInspector);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpPaletteEvents_OnNameChanged_Proxy(
    IZcPpPaletteEvents * This,
     BSTR newName);
void __RPC_STUB IZcPpPaletteEvents_OnNameChanged_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteEvents_OnSelectionChanged_Proxy(
    IZcPpPaletteEvents * This,
     VARIANT *newObjectArray,
     VARIANT *newPropMgrArray,
     VARIANT_BOOL *bHandled);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_AddPalette_Proxy(
    IZcPpPaletteSet * This,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSet_AddPalette_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_DeletePalette_Proxy(
    IZcPpPaletteSet * This,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSet_DeletePalette_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_InsertPalette_Proxy(
    IZcPpPaletteSet * This,
     int index,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSet_InsertPalette_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_GetPalette_Proxy(
    IZcPpPaletteSet * This,
     int index,
     IZcPpPalette **pPalette);
void __RPC_STUB IZcPpPaletteSet_GetPalette_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_GetPaletteByName_Proxy(
    IZcPpPaletteSet * This,
     BSTR paletteName,
     IZcPpPalette **pPalette);
void __RPC_STUB IZcPpPaletteSet_GetPaletteByName_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_ActivatePalette_Proxy(
    IZcPpPaletteSet * This,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSet_ActivatePalette_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_get_PaletteCount_Proxy(
    IZcPpPaletteSet * This,
     int *nPalettes);
void __RPC_STUB IZcPpPaletteSet_get_PaletteCount_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_get_Visibility_Proxy(
    IZcPpPaletteSet * This,
     VARIANT_BOOL *bIsVisible);
void __RPC_STUB IZcPpPaletteSet_get_Visibility_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_put_Visibility_Proxy(
    IZcPpPaletteSet * This,
     VARIANT_BOOL bIsVisible);
void __RPC_STUB IZcPpPaletteSet_put_Visibility_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_get_CurrentIndex_Proxy(
    IZcPpPaletteSet * This,
     int *nCurrentIndex);
void __RPC_STUB IZcPpPaletteSet_get_CurrentIndex_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_GetDockingState_Proxy(
    IZcPpPaletteSet * This,
     int *nDockPos,
     long *left,
     long *top,
...
void __RPC_STUB IZcPpPaletteSet_GetDockingState_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_SetDockingState_Proxy(
    IZcPpPaletteSet * This,
     int nDockPos,
     long left,
     long top,
...
void __RPC_STUB IZcPpPaletteSet_SetDockingState_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_GetFloatingRect_Proxy(
    IZcPpPaletteSet * This,
     long *left,
     long *top,
     long *width,
...
void __RPC_STUB IZcPpPaletteSet_GetFloatingRect_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSet_GetDockingRect_Proxy(
    IZcPpPaletteSet * This,
     int *nDockPos,
     long *left,
     long *top,
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSetEvents_OnPaletteAdded_Proxy(
    IZcPpPaletteSetEvents * This,
     IZcPpPalette *pNewPalette);
void __RPC_STUB IZcPpPaletteSetEvents_OnPaletteAdded_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSetEvents_OnPaletteDeleted_Proxy(
    IZcPpPaletteSetEvents * This,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSetEvents_OnPaletteDeleted_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSetEvents_OnPaletteActivated_Proxy(
    IZcPpPaletteSetEvents * This,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSetEvents_OnPaletteActivated_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSetEvents_OnPaletteDeActivated_Proxy(
    IZcPpPaletteSetEvents * This,
     IZcPpPalette *pPalette);
void __RPC_STUB IZcPpPaletteSetEvents_OnPaletteDeActivated_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSetEvents_OnSelectionChanged_Proxy(
    IZcPpPaletteSetEvents * This,
     VARIANT *newObjectArray,
     VARIANT *newPropMgrArray);
void __RPC_STUB IZcPpPaletteSetEvents_OnSelectionChanged_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPaletteSetEvents_OnVisibilityChanged_Proxy(
    IZcPpPaletteSetEvents * This,
     VARIANT_BOOL bIsVisible);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNode_get_ID_Proxy(
    IZcPpNavTreeNode * This,
     long *pID);
void __RPC_STUB IZcPpNavTreeNode_get_ID_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNode_get_ParentID_Proxy(
    IZcPpNavTreeNode * This,
     long *pID);
void __RPC_STUB IZcPpNavTreeNode_get_ParentID_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNode_get_Label_Proxy(
    IZcPpNavTreeNode * This,
     BSTR *pLabel);
void __RPC_STUB IZcPpNavTreeNode_get_Label_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNode_get_LeftIconRes_Proxy(
    IZcPpNavTreeNode * This,
     BSTR *pPath);
void __RPC_STUB IZcPpNavTreeNode_get_LeftIconRes_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNode_get_LeftIconResType_Proxy(
    IZcPpNavTreeNode * This,
     ULONG *pVal);
void __RPC_STUB IZcPpNavTreeNode_get_LeftIconResType_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNode_GetObject_Proxy(
    IZcPpNavTreeNode * This,
    VARIANT *pObject);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollectionIter_Start_Proxy(
    IZcPpNavTreeNodeCollectionIter * This);
void __RPC_STUB IZcPpNavTreeNodeCollectionIter_Start_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollectionIter_Next_Proxy(
    IZcPpNavTreeNodeCollectionIter * This);
void __RPC_STUB IZcPpNavTreeNodeCollectionIter_Next_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollectionIter_Current_Proxy(
    IZcPpNavTreeNodeCollectionIter * This,
     IZcPpNavTreeNode **pNode);
void __RPC_STUB IZcPpNavTreeNodeCollectionIter_Current_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollectionIter_Done_Proxy(
    IZcPpNavTreeNodeCollectionIter * This,
     VARIANT_BOOL *pBool);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollection_AddNode_Proxy(
    IZcPpNavTreeNodeCollection * This,
     IZcPpNavTreeNode *pNode);
void __RPC_STUB IZcPpNavTreeNodeCollection_AddNode_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollection_DeleteNode_Proxy(
    IZcPpNavTreeNodeCollection * This,
     IZcPpNavTreeNode *pNode);
void __RPC_STUB IZcPpNavTreeNodeCollection_DeleteNode_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollection_DeleteAllNodes_Proxy(
    IZcPpNavTreeNodeCollection * This);
void __RPC_STUB IZcPpNavTreeNodeCollection_DeleteAllNodes_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeNodeCollection_GetNodeCollectionIter_Proxy(
    IZcPpNavTreeNodeCollection * This,
     IZcPpNavTreeNodeCollectionIter **PIter);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtn_get_Name_Proxy(
    IZcPpNavTreeCmdBtn * This,
     BSTR *pName);
void __RPC_STUB IZcPpNavTreeCmdBtn_get_Name_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtn_GetBtnImage_Proxy(
    IZcPpNavTreeCmdBtn * This,
     BSTR *pPath,
     ULONG *pImgType);
void __RPC_STUB IZcPpNavTreeCmdBtn_GetBtnImage_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtn_Execute_Proxy(
    IZcPpNavTreeCmdBtn * This);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollectionIter_Start_Proxy(
    IZcPpNavTreeCmdBtnCollectionIter * This);
void __RPC_STUB IZcPpNavTreeCmdBtnCollectionIter_Start_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollectionIter_Next_Proxy(
    IZcPpNavTreeCmdBtnCollectionIter * This);
void __RPC_STUB IZcPpNavTreeCmdBtnCollectionIter_Next_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollectionIter_Current_Proxy(
    IZcPpNavTreeCmdBtnCollectionIter * This,
     IZcPpNavTreeCmdBtn **pNode);
void __RPC_STUB IZcPpNavTreeCmdBtnCollectionIter_Current_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollectionIter_Done_Proxy(
    IZcPpNavTreeCmdBtnCollectionIter * This,
     VARIANT_BOOL *pBool);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollection_AddButton_Proxy(
    IZcPpNavTreeCmdBtnCollection * This,
     IZcPpNavTreeCmdBtn *pBtn);
void __RPC_STUB IZcPpNavTreeCmdBtnCollection_AddButton_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollection_DeleteButton_Proxy(
    IZcPpNavTreeCmdBtnCollection * This,
     IZcPpNavTreeCmdBtn *pBtn);
void __RPC_STUB IZcPpNavTreeCmdBtnCollection_DeleteButton_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollection_DeleteAllButtons_Proxy(
    IZcPpNavTreeCmdBtnCollection * This);
void __RPC_STUB IZcPpNavTreeCmdBtnCollection_DeleteAllButtons_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeCmdBtnCollection_GetCmdBtnCollectionIter_Proxy(
    IZcPpNavTreeCmdBtnCollection * This,
     IZcPpNavTreeCmdBtnCollectionIter **pIter);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTree_Reset_Proxy(
    IZcPpNavTree * This,
     IZcPpNavTreeNodeCollection *pNodeCollection,
     IZcPpNavTreeCmdBtnCollection *pCmdBtnCollection);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeEvents_OnSelectionChanged_Proxy(
    IZcPpNavTreeEvents * This,
     VARIANT *pIntArray,
     VARIANT *pObjUnkArray,
     VARIANT_BOOL *bHandled);
void __RPC_STUB IZcPpNavTreeEvents_OnSelectionChanged_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpNavTreeEvents_OnDblClickTreeItem_Proxy(
    IZcPpNavTreeEvents * This,
     ULONG index,
     UINT nResourceId);
...
#endif
#endif
 HRESULT STDMETHODCALLTYPE IZcPpPalette2_get_NavTree_Proxy(
    IZcPpPalette2 * This,
     IZcPpNavTree **pNavTree);
void __RPC_STUB IZcPpPalette2_get_NavTree_Stub(
    ...
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE IZcPpPalette2_put_NavTree_Proxy(
    IZcPpPalette2 * This,
     IZcPpNavTree *pNavTree);
...
class DECLSPEC_UUID("9B94F83D-3907-4B95-8627-E0AF199C83DC")
ZcPpZcadInput;
#endif
...
class DECLSPEC_UUID("F26C9131-4E5E-43E8-AA11-B34B2252FE05")
ZcPpPaletteSet;
#endif
...
class DECLSPEC_UUID("0E4A2894-AEC0-4BC0-AFE3-1A0837289AA2")
ZcPpPalette;
#endif
