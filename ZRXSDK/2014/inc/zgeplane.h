...
public:
    ...
    ZcGePlane(const ZcGePoint3d& pntU, const ZcGePoint3d& or, const ZcGePoint3d& pntV);
    ZcGePlane(const ZcGePoint3d& or, const ZcGeVector3d& uAxis,
    ...
    ZcGePlane&     set              (const ZcGePoint3d& pntU, const ZcGePoint3d& or,
                                     const ZcGePoint3d& pntV);
    ZcGePlane&     set              (double a, double b, double c, double d);
    ZcGePlane&     set              (const ZcGePoint3d& or,
