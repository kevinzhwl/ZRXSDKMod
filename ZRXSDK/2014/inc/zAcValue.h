...
public:
    ...
    ZCDB_PORT       operator long           (void) const;
    ...
    ZCDB_PORT ZcValue& operator=            (long lValue);
    ...
    ZCDB_PORT bool  get                     (long& lValue) const;
    ...
    ZCDB_PORT bool  set                     (long lValue);
